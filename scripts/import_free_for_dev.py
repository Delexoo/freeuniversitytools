...
# free-for-dev README section -> dedicated student.html data-category slug
# Keep in sync with scripts/split_free_for_dev_categories.py
SECTION_MAP: dict[str, str] = {
    "Major Cloud Providers": "cloud-providers",
    "Cloud management solutions": "cloud-management",
    "Source Code Repos": "source-code-repos",
    "APIs, Data, and ML": "api-data-ml",
    "Artifact Repos": "artifact-repos",
    "Tools for Teams and Collaboration": "team-collaboration",
    "CMS": "cms",
    "Code Generation": "code-generation",
    "Code Quality": "code-quality",
    "Code Search and Browsing": "code-search",
    "CI and CD": "ci-cd",
    "Testing": "testing-tools",
    "Security and PKI": "security-pki",
    "Authentication, Authorization, and User Management": "authentication",
    "Mobile App Distribution and Feedback": "mobile-distribution",
    "Management System": "management-systems",
    "Messaging and Streaming": "messaging",
    "Log Management": "log-management",
    "Translation Management": "translation-management",
    "Monitoring": "monitoring",
    "Crash and Exception Handling": "crash-reporting",
    "Search": "search-tools",
    "Education and Career Development": "dev-education",
    "Email": "email",
    ...
    "PaaS": "paas",
    "BaaS": "baas",
    "Low-code Platform": "low-code",
    "Web Hosting": "web-hosting",
    "DNS": "dns",
    "Domain": "domains",
    "IaaS": "iaas",
    "Managed Data Services": "managed-data",
    "Tunneling, WebRTC, Web Socket Servers and Other Routers": "tunneling",
    "Issue Tracking and Project Management": "issue-tracking",
    "Storage and Media Processing": "storage-media",
    "Design and UI": "design",
    "Data Visualization on Maps": "maps",
    "Package Build System": "package-build",
    "IDE and Code Editing": "code-editors",
    "Analytics, Events and Statistics": "analytics",
    "Visitor Session Recording": "session-recording",
    "International Mobile Number Verification API and SDK": "phone-apis",
    "Payment and Billing Integration": "payment-billing",
    "Docker Related": "docker",
    "Dev Blogging Sites": "dev-blogging",
    "Commenting Platforms": "commenting",
    "Screenshot APIs": "screenshot-apis",
    "Flutter Related and Building IOS Apps without Mac": "flutter-tools",
    "Privacy Management": "privacy-management",
    "Miscellaneous": "dev-misc",
    "Remote Desktop Tools": "remote-desktop",
    "Other Free Resources": "dev-resources",
}
